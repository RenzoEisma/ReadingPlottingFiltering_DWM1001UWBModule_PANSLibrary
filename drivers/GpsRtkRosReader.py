...
Assistance note: ChatGPT Pro 5.5 Thinking Extended was used to update the script from XYZ-topic input to GPS
latitude/longitude/altitude input with local ENU conversion. The rewritten version should be checked by a human.
