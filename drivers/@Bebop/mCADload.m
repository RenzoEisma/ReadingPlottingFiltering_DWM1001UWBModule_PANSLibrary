...
obj.pCAD.obj = loadawobj('ArDroneCAD.obj');
obj.pCAD.mtl = loadawmtl('ArDroneCAD.mtl');

% Flags
obj.pCAD.flagLoaded  = 1;  % 3D image loaded
obj.pCAD.flagCreated = 0;  % 3D image created using Matlab Patch function
obj.pCAD.flagLines   = 1;  % Illustrate lines between ArDrone and surface

vExt = minmax(obj.pCAD.obj.v);
mExt = mean(vExt,2);
for ii = 1:3
    obj.pCAD.obj.v(ii,:) = (obj.pCAD.obj.v(ii,:) - mExt(ii))/1000;
end

obj.pCAD.obj.v = [0 1 0; -1 0 0; 0 0 1]*obj.pCAD.obj.v;
