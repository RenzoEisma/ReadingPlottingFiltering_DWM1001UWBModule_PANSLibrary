...
# reading data from the custom UWB PCB. It isn't very clean, so in the future it should be seperated into two scripts.
# !!!!!!!!!!!!!!!!!!!!!
# =====================================================================================================================
...
DEFAULT_BAUD = 115200
DEFAULT_POSITION_COMMAND = "lec" # Command sent to MDEK listener module via UART
DEFAULT_COMBINE_WINDOW = 0.5

# Two network configuration settings:
# ---------------------------------------------------------------------------------------------------------------------
...
# Unit: meters
# Conversion used: estimated_center = measured_tag_position - rotated_tag_offset_from_center
...
# PANS quality is higher = better. Values <= 0 are treated as invalid/very weak.
# ---------------------------------------------------------------------------------------------------------------------
...
# Checks whether a UWB position can be used.
# ---------------------------------------------------------------------------------------------------------------------
